export default function BlurBackground() {
  return (
    <>
      ...
      <div className="absolute top-0 left-80 -translate-y-1/2 w-120 h-64 bg-(--purple-primary) rounded-full blur-[140px] -z-10"></div>
      ...
      <div className="absolute top-350 right-70 w-140 h-140 bg-(--purple-primary) rounded-full blur-[120px] -z-10"></div>
    </>
  );
}
